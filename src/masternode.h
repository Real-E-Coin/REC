...
//
// The Masternode Class. It contains the input of the 10000 REC, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 REC - checking if valid masternode)
