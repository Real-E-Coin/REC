...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Real E Coin"),
     ...
     * override -datadir in the real_e_coin.conf file in the default data directory
     * (to be consistent with real_e_coind behavior)
     */
