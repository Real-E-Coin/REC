...
#include "qt/real_e_coin/sendcustomfeedialog.h"
#include "qt/real_e_coin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(Real_E_CoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &Real_E_CoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
