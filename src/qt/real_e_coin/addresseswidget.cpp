...
#include "qt/real_e_coin/forms/ui_addresseswidget.h"
#include "qt/real_e_coin/addresslabelrow.h"
#include "qt/real_e_coin/addnewaddressdialog.h"
#include "qt/real_e_coin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(Real_E_CoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination recAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(recAdd, label.toUtf8().constData(),
