...
#include "qt/real_e_coin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(Real_E_CoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Real_E_Coin_tx_csv_export(*.csv)") : tr("Real_E_Coin_addresses_csv_export(*.csv)"),
                                        nullptr);
