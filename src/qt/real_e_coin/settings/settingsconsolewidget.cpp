...
#include "qt/real_e_coin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/real_e_coin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(Real_E_CoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Real E Coin RPC console.") + "<br>" +
