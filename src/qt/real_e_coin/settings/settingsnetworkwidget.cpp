...
#include "qt/real_e_coin/settings/settingsnetworkwidget.h"
#include "qt/real_e_coin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/real_e_coin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(Real_E_CoinGUI* _window, QWidget *parent) :
