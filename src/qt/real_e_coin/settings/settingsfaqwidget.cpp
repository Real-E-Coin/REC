...
#include "qt/real_e_coin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/real_e_coin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(Real_E_CoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableREC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableREC,
    ...
    connect(ui->pushButton_UnspendableREC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableREC);});
    ...
    if (parent)
        connect(parent, &Real_E_CoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
