...
#include "qt/real_e_coin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(Real_E_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &Real_E_CoinGUI::openFAQ);
