...
#include "qt/real_e_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/real_e_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(Real_E_CoinGUI* _window, QWidget *parent) :
