...
#include "qt/real_e_coin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/real_e_coin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(Real_E_CoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to Real_E_CoinGUI::handleRestart()
