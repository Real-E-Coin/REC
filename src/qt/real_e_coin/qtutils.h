...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, Real_E_CoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, Real_E_CoinGUI* gui, double posX = 3);
