...
#include "qt/real_e_coin/navmenuwidget.h"
#include "qt/real_e_coin/topbar.h"
#include "qt/real_e_coin/dashboardwidget.h"
#include "qt/real_e_coin/send.h"
#include "qt/real_e_coin/receivewidget.h"
#include "qt/real_e_coin/addresseswidget.h"
#include "qt/real_e_coin/coldstakingwidget.h"
#include "qt/real_e_coin/masternodeswidget.h"
#include "qt/real_e_coin/snackbar.h"
#include "qt/real_e_coin/settings/settingswidget.h"
...
/**
  Real_E_Coin GUI main class. This class represents the main window of the Real_E_Coin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class Real_E_CoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Real_E_CoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~Real_E_CoinGUI();
