...
#include "qt/real_e_coin/forms/ui_send.h"
#include "qt/real_e_coin/addnewcontactdialog.h"
#include "qt/real_e_coin/qtutils.h"
#include "qt/real_e_coin/sendchangeaddressdialog.h"
#include "qt/real_e_coin/optionbutton.h"
#include "qt/real_e_coin/sendconfirmdialog.h"
#include "qt/real_e_coin/myaddressrow.h"
#include "qt/real_e_coin/guitransactionsutils.h"
...
SendWidget::SendWidget(Real_E_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-rec");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination recAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(recAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(recAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
