...
#ifndef REAL_E_COIN_QT_WALLETMODEL_H
#define REAL_E_COIN_QT_WALLETMODEL_H
...
/** Interface to Real_E_Coin wallet from Qt view code. */
...
#endif // REAL_E_COIN_QT_WALLETMODEL_H
