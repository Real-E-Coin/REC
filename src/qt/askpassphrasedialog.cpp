...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            Real_E_CoinGUI* window = static_cast<Real_E_CoinGUI*>(parentWidget());
...
{
    Real_E_CoinGUI* gui = static_cast<Real_E_CoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<Real_E_CoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Real_E_Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your RECs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
