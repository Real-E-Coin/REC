...
/** Utility functions used by the Real_E_Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render Real_E_Coin addresses in monospace font
...
// Parse "real_e_coin:" URI into recipient object, return true on successful parsing
