...
/* Real_E_Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Real_E_Coin"
#define QAPP_ORG_DOMAIN "real_e_coin.org"
#define QAPP_APP_NAME_DEFAULT "Real_E_Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Real_E_Coin-Qt-testnet"
