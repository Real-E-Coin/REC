...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Real_E_Coin real_e_coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  real_e_coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded real_e_coin transaction") + "\n" +
                               "  real_e_coin-tx [options] -create [commands]   " + _("Create hex-encoded real_e_coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded real_e_coin transaction
