...
#define BOOST_TEST_MODULE Real_E_Coin Test Suite
...
{
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_real_e_coin_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
