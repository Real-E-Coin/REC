    ...
    for (unsigned int i = 0; i < NUM_SIMULATION_ITERATIONS; i++) {
        ...
        if (randiter % 20 < 19) {
            ...
            if (randiter % 20 < 2 || coinbase_coins.size() < 10) {
                // Real_E_Coin: don't test for duplicate coinbases as those are not possible due to
...
BOOST_AUTO_TEST_CASE(ccoins_serialization)
{
    ...
    // Real_E_Coin: Example with fCoinStake
...
BOOST_AUTO_TEST_CASE(ccoins_add)
{
     ...
     *
     * Real_E_Coin: Remove Coinbase argument (ref: https://github.com/Real_E_Coin-Project/Real_E_Coin/pull/1775)
     *
