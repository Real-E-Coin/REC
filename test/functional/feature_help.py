...
"""Verify that starting real_e_coin with -h works as expected."""
import subprocess

from test_framework.test_framework import Real_E_CoinTestFramework
from test_framework.util import assert_equal

class HelpTest(Real_E_CoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start real_e_coin with -? for help text")
        ...
        self.log.info("Start real_e_coin with -version for version information")
