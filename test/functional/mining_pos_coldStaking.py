...
from test_framework.real_e_coin_node import Real_E_CoinTestNode
...
class Real_E_Coin_ColdStakingTest(Real_E_CoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(Real_E_CoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 REC from the pot)
...
if __name__ == '__main__':
    Real_E_Coin_ColdStakingTest().main()
