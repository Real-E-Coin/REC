...
class BudgetProposalTest(Real_E_CoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Real_E_Coin address")
        assert_raises_rpc_error(-5, "Invalid Real_E_Coin address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 REC allowed", self.nodes[0].preparebudget,
