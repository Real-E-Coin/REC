...
The script [extract-osx-sdk.sh](https://github.com/real_e_coin-project/real_e_coin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
real_e_coin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/real_e_coin-project/real_e_coin/blob/master/doc/README_osx.md) for troubleshooting tips.
