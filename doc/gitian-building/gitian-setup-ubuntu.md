...
The build script we'll be using is contained in the Real_E_Coin github repository ([contrib/gitian-build.py](https://github.com/Real-E-Coin/REC/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Real_E_Coin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Real-E-Coin/REC/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, real_e_coin-detached-sigs, and real_e_coin GitHub repos.
