Contributing to Real_E_Coin
============================

The Real_E_Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/real_e_coin-project/real_e_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Real_E_Coin project, and is not to be
confused with overall Real_E_Coin Network Protocol consensus changes.

Whether a pull request is merged into Real_E_Coin rests with the project merge
...
Patches that change Real_E_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Real_E_Coin consensus, it must have been
...
The project leader is the release manager for each Real_E_Coin release.
