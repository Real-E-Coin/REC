...
def main():
    ...
    # Filter out hosts with multiple real_e_coin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple real_e_coin ports' % (ip_stats(ips)), file=sys.stderr)
