...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/real_e_coin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/real_e_coin-cli.cpp \
           src/real_e_coin-tx.cpp \
           src/real_e_coin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/real_e_coin.qrc src/qt/real_e_coin_locale.qrc

TRANSLATIONS += src/qt/locale/real_e_coin_bg.ts \
                src/qt/locale/real_e_coin_de.ts \
                src/qt/locale/real_e_coin_en.ts \
                src/qt/locale/real_e_coin_es.ts \
                src/qt/locale/real_e_coin_fi.ts \
                src/qt/locale/real_e_coin_fr.ts \
                src/qt/locale/real_e_coin_it.ts \
                src/qt/locale/real_e_coin_ja.ts \
                src/qt/locale/real_e_coin_pl.ts \
                src/qt/locale/real_e_coin_pt.ts \
                src/qt/locale/real_e_coin_ru.ts \
                src/qt/locale/real_e_coin_sk.ts \
                src/qt/locale/real_e_coin_sv.ts \
                src/qt/locale/real_e_coin_vi.ts \
                src/qt/locale/real_e_coin_zh_CN.ts \
                src/qt/locale/real_e_coin_zh_TW.ts
